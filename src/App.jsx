  ...
  return (
    <>
      <div className="w-full ">
        ...
        {/* Sections */}
        <div id="home" className="relative w-full bg-gradient-to-t from-sky-500 to-blue-700 flex flex-col md:flex-row items-center justify-center  text-white text-center px-6 pt-24">
